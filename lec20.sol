...
contract lec20 {
    ...
    function createCharacter(uint256 _age, string memory _name, string memory _job) public pure returns (Character memory) {
    ...
    function getCharacterMapping(uint256 _index) public view returns (Character memory) {
